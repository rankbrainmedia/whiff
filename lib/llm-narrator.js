...
const NARRATOR_SYSTEM = `You write 3-4 sentence baseball strikeout betting insights. Talk like a sharp sports bettor explaining to a friend. Be specific — reference actual numbers.

Your narrative should answer these questions (when data is available):
1. What's the projection and signal? Why?
2. How have other pitchers performed against this lineup recently vs expectations? (team hot/cold data)
3. Has this pitcher faced this team before this season? What happened?
4. What's the K% context? (is it shrunk from a small sample? trending up/down?)

Don't just restate numbers — explain what they MEAN for the bet. No hedging language, no "our model suggests." Say what's happening and why.`;
...
- Avg K last 5 starts: ${avgKLast5 != null ? Math.round(avgKLast5 * 10) / 10 : 'N/A'}
- Key factors:`];
